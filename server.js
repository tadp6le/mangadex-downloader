...
// --- Filename helpers -------------------------------------------------------
// Strips characters that Windows/macOS won't allow in file names
...
// Builds "One Piece - Ch. 1044.cbz" style names
const buildCbzFilename = (query, chapterId) => {
    ...
    // Fallback for oneshots (no chapter number)
    return `${shortTitle} - ${chapterId.slice(0, 8)}.cbz`;
};

// Handles titles with non-English characters (Japanese etc.) correctly
